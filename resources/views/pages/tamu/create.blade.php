                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <select class="form-select @error('jenis_identitas_id') is-invalid @enderror"
                                    id="jenis_identitas_id" name="jenis_identitas_id" required>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('tujuan') is-invalid @enderror" id="tujuan"
                                    name="tujuan" rows="3" required>{{ old('tujuan') }}</textarea>
                                @error('tujuan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control @error('tanggal_kunjungan') is-invalid @enderror"
                                    ...
                                    value="{{ old('tanggal_kunjungan', \Illuminate\Support\Carbon::now()->format('Y-m-d')) }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="time" class="form-control @error('jam_kunjungan') is-invalid @enderror"
                                    ...
                                    value="{{ old('jam_kunjungan', \Illuminate\Support\Carbon::now()->format('H:i')) }}">
                                @error('jam_kunjungan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="number" class="form-control @error('jumlah_rombongan') is-invalid @enderror"
                                    id="jumlah_rombongan" name="jumlah_rombongan" value="{{ old('jumlah_rombongan', 1) }}"
                                    min="1">
